...
const Errors = require("../api/errors/derkach-main-error.js");
...
const logger = LoggerFactory.get("DerkachMainAbl");

class DerkachMainAbl {
  constructor() {
...
module.exports = new DerkachMainAbl();
