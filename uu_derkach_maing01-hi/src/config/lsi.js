const Lsi = {
  appName: {
    cs: "Aplikace uuDerkach",
    en: "Application uuDerkach",
  },
  ...
  about: {
    header: {
      cs: "O aplikaci uuDerkach",
      en: "About application uuDerkach",
    },
    creatorsHeader: {
      cs: "Tvůrci aplikace",
  ...
  unauthInit: {
    buyYourOwn: {
      cs: "Můžete si koupit vlastní uuDerkach.",
      en: "You can buy your own uuDerkach.",
    },
    notAuthorized: {
      cs: "Nemáte právo inicializovat tuto aplikaci uuDerkach.",
      en: "You don't have rights to initialize this uuDerkach.",
    },
  },
